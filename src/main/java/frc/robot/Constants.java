...
public class Constants {
  ...
  public static final class FieldConstants {
    ...
    public static Pose2d RED_DEPOT = new Pose2d(15.05, 1.977, Rotation2d.kZero);
    ...
    public static Pose2d RED_SHOOT_MIDDLE = new Pose2d(13.5, 4.037, Rotation2d.fromDegrees(180));
