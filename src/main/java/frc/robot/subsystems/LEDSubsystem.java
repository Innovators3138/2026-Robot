...
public class LEDSubsystem extends SubsystemBase {
  ...
  public LEDSubsystem(ShooterSubsystem shooterSubsystem, SwerveSubsystem swerveSubsystem) {
    ...
    leftAimController =
        new LEDRangeController(17, 8, 45.0, false, "Subsystems/LED/LeftAim/LitLEDCount");
    rightAimController =
        new LEDRangeController(19, 28, 45.0, false, "Subsystems/LED/RightAim/LitLEDCount");
    speedController =
  ...
  public void periodic() {
    candle.setControl(new SolidColor(18, 18).withColor(new RGBWColor(0, 0, 0, 0)));
