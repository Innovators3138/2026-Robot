...
public class SwerveSubsystem extends SubsystemBase {
    ...
    public SwerveSubsystem() {
        ...
        try {
            m_SwerveDrive = new SwerveParser(swerveJsonDirectory).createSwerveDrive(1, new Pose2d(1, 4, Rotation2d.kZero));
    ...
    public SwerveInputStream getInputStream(CommandXboxController controller) {
        return SwerveInputStream.of(m_SwerveDrive, ()-> controller.getLeftY() * -1, ()-> controller.getLeftX() * -1);
    }
